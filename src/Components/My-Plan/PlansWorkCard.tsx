...
const PlansWorkCard = ({ item }: CardProps) => {
  ...
  return (
    <div className="bg-[#15171E] p-4 rounded-xl border border-gray-800 flex justify-between items-center w-full">
      ...
      <div className="flex items-center gap-3 shrink-0">
        ...
        <button className="bg-[#C2F800] hover:bg-[#a6d800] text-black px-4 py-2 rounded-full text-sm font-bold flex items-center gap-1 transition-colors">
          ✓ Mark as Done
        </button>
